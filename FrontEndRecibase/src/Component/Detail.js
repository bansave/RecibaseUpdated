...
class Detail extends Component{
  ...
  componentWillMount(){
    ...
    .then((getdata) => {
      ...
      this.props.DetailItem({namaresep: this.state.RecipeList2.resep[0][0].recipe_name, bahan: this.state.RecipeList2.resep[2] , bumbu: this.state.RecipeList2.resep[3], alat: this.state.RecipeList2.resep[1], step: this.state.RecipeList2.resep[0][0].recipe_steps, image: this.state.RecipeList2.resep[4][0].image})
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-md-3">
          <img className="img-fluid" src={"http://localhost:3300/images/"+this.props.image} alt=""/>
        </div>
...
const mapStateToProps = (state) => {
  ...
  return { namaresep: state.DataDetail.namaresep, bahan: state.DataDetail.bahan, bumbu: state.DataDetail.bumbu,alat: state.DataDetail.alat, step: state.DataDetail.step, image: state.DataDetail.image, selectedID: state.IDselector.ID};
};
